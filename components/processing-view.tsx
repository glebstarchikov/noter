    ...
    return (
      <div className="flex flex-col items-center gap-4 rounded-xl border border-destructive/30 bg-card px-6 py-16">
        ...
        <div className="flex items-center gap-3">
          <Link
            href="/dashboard/new"
            className="rounded-lg bg-foreground px-4 py-2 text-sm font-medium text-background hover:bg-foreground/90 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring"
          >
            Try again
          </Link>
          {meetingId && (
      ...
      {currentStep === 'done' && meetingId && (
        <div className="mt-4 flex justify-center">
          <Link
            ...
            className="rounded-lg bg-foreground px-6 py-2.5 text-sm font-medium text-background hover:bg-foreground/90 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring"
          >
            View meeting notes
          </Link>
        </div>
