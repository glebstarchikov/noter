import { DOCX_MIME, DOCUMENT_MEDIA_TYPES, isDocumentAttachment, isImageAttachment } from '@/lib/attachment-kind'

export { DOCUMENT_MEDIA_TYPES, isDocumentAttachment, isImageAttachment }
